...
#define equalize_fastnldenoising_run 1
#define detect_crop_run 0
#define model_build_run 1
#define user_train_run 0
#define user_test 1
// For testing purpose
#define model_eigen_test_run 1
#define write_file_run 1
...
//*****************************************************************************
	...
	if( model_eigen_test_run ==1)
	{
		model_eigen_test	(images, labels, actual_labels, predicted_labels);
